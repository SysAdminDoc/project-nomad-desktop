...
- **SQLite** — 102 tables, WAL mode, 30s timeout, FK enforcement, SQLite backup API, 148 performance indexes
...
db.py                 # SQLite init (102 tables), organized into 6 _create_*_tables() helpers + _apply_column_migrations() + _create_indexes(). db_session() context manager
