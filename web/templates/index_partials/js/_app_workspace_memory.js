...
const WORKSPACE_TAB_META = {
  ...
  // Operations
  'water-mgmt': {label: 'Water', icon: '&#128167;', summary: 'Plan storage, source, purification, and rationing for off-grid water.'},
  financial: {label: 'Financial', icon: '&#128176;', summary: 'Track cash, hard assets, debt, and contingency reserves.'},
  vehicles: {label: 'Vehicles', icon: '&#128663;', summary: 'Maintenance schedules, fuel logs, and vehicle readiness.'},
  loadout: {label: 'Loadout', icon: '&#127890;', summary: 'Bug-out bags, kit lists, and per-loadout weight budgets.'},
  'movement-ops': {label: 'Movement', icon: '&#129517;', summary: 'Plan routes, bug-out paths, and overland navigation.'},
  'tactical-comms': {label: 'Tac Comms', icon: '&#128225;', summary: 'HF/UHF/VHF, mesh, and field comms procedures.'},
  'medical-phase2': {label: 'Med+', icon: '&#9877;', summary: 'Pregnancy, dental, chronic, mental health, vet, and herbal care.'},
  'group-ops': {label: 'Group Ops', icon: '&#128101;', summary: 'Roles, watch rotations, group governance, and coordination.'},
  'security-opsec': {label: 'OPSEC', icon: '&#128737;', summary: 'Counter-surveillance, comms hygiene, and threat awareness.'},
  'disaster-modules': {label: 'Disasters', icon: '&#9928;', summary: 'Hurricane, wildfire, earthquake, flood, and pandemic playbooks.'},
  'daily-living': {label: 'Daily Living', icon: '&#127969;', summary: 'Cooking, sanitation, hygiene, and household routines off-grid.'},
  'hunting-foraging': {label: 'Wild Food', icon: '&#129432;', summary: 'Game, fish, foraging, and wild-food calendars.'},
  'specialized-modules': {label: 'Specialized', icon: '&#127919;', summary: 'Narrow-domain operational modules and field procedures.'},
  // Briefing & knowledge
  timeline: {label: 'Timeline', icon: '&#128197;', summary: 'Unified view of expirations, maintenance, drills, and tasks.'},
  'threat-intel': {label: 'Threats', icon: '&#9888;', summary: 'Track threat indicators, watchlists, and risk posture.'},
  'land-assessment': {label: 'Land', icon: '&#127748;', summary: 'Site survey, terrain, water, soil, and resource scoring.'},
  agriculture: {label: 'Agriculture', icon: '&#127793;', summary: 'Permaculture planning, crops, livestock, and seed management.'},
  'training-knowledge': {label: 'Training', icon: '&#127891;', summary: 'Skill drills, courses, and knowledge progression.'},
  interoperability: {label: 'Interoperability', icon: '&#128229;', summary: 'Import, export, and exchange data with other systems.'},
  // System
  'hardware-sensors': {label: 'Hardware', icon: '&#128268;', summary: 'Sensors, mesh nodes, comms hardware, and IoT inventory.'},
  'platform-security': {label: 'Security', icon: '&#128274;', summary: 'Auth, hardening, audit logs, and platform integrity.'},
  'data-foundation': {label: 'Data Packs', icon: '&#128230;', summary: 'Reference packs, datasets, and offline knowledge bundles.'},
  nukemap: {label: 'NukeMap', icon: '&#9762;', summary: 'Nuclear blast modeling and consequence visualization.'},
  viptrack: {label: 'VIPTrack', icon: '&#9992;', summary: 'Live military and VIP air traffic tracking.'},
};
...
const WORKSPACE_GROUP_LABELS = {
  ...
  maps: 'Operations',
  tools: 'Operations',
  'water-mgmt': 'Operations',
  financial: 'Operations',
  vehicles: 'Operations',
  loadout: 'Operations',
  'movement-ops': 'Operations',
  'tactical-comms': 'Operations',
  'medical-phase2': 'Operations',
  'group-ops': 'Operations',
  'security-opsec': 'Operations',
  'disaster-modules': 'Operations',
  'daily-living': 'Operations',
  'hunting-foraging': 'Operations',
  'specialized-modules': 'Operations',
  viptrack: 'Operations',
  nukemap: 'Operations',
  'kiwix-library': 'Knowledge',
  notes: 'Knowledge',
  media: 'Knowledge',
  'land-assessment': 'Knowledge',
...
function getCommandPaletteCommands() {
  ...
  const staticCommands = [
    ...
    {id: 'act-open-docs', section: 'Quick Actions', title: 'Open Command Help', subtitle: 'Review navigation, utility, and command-palette actions', keywords: 'help command guide navigation actions', icon: '&#63;', priority: 70, run: () => { if (typeof toggleShortcutsHelp === 'function') toggleShortcutsHelp(); }},
