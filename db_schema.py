"""Schema creation functions extracted from db.py."""
...
__all__ = [
    '_create_core_tables',
    '_create_comms_media_tables',
    '_create_federation_tables',
    '_create_medical_security_tables',
    '_create_power_garden_tables',
    '_create_extended_tables',
    '_create_water_financial_vehicle_loadout_tables',
    '_create_pace_evac_container_tables',
    '_create_readiness_alerts_threat_drill_tables',
    '_create_kb_chunks_table',
    '_create_guidance_sources_table',
    '_create_indexes',
    '_create_data_foundation_tables',
    '_create_meal_planning_tables',
    '_create_consumption_water_budget_tables',
    '_create_movement_ops_tables',
    '_create_tactical_comms_tables',
    '_create_land_assessment_tables',
    '_create_medical_phase2_tables',
    '_create_training_knowledge_tables',
    '_create_group_ops_tables',
    '_create_security_opsec_tables',
    '_create_agriculture_tables',
    '_create_disaster_modules_tables',
    '_create_daily_living_tables',
    '_create_interoperability_tables',
    '_create_hunting_foraging_tables',
    '_create_hardware_sensors_tables',
    '_create_platform_security_tables',
    '_create_specialized_modules_tables',
    '_create_roadmap_v747_tables',
    '_create_rag_scope_table',
    '_create_fts5_tables',
]
