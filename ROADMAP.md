...
| V8-06 | **Blueprint test coverage** | ~40 of 72 blueprints lack test suites. **`roadmap_features.py`** covered v7.65.1-pre follow-up (`89d1818`, 25 tests across 6 families). **`specialized_modules.py`** covered 2026-04-24 late-PM (`d581cd4`, 38 tests across 14 resources — 1,794 LOC / 60+ routes; surfaced 4 follow-up findings). **`disaster_modules.py`** covered 2026-04-24 late-PM (`tests/test_blueprint_disaster_modules.py`, 38 tests across 9 resources — plans+reference, checklists+seed/auto-pct, energy+summary, construction+materials, materials+low-stock, fortifications+assessment, heating calc, sandbag calc, summary dashboard — 898 LOC / 35+ routes). Still open: `daily_living.py`, `hunting_foraging.py`, `hardware_sensors.py`, `supplies.py`, `land_assessment.py`, `benchmark.py`, `brief.py`, `kb.py`, `kiwix.py`, `federation.py`, and ~27 others. | **Partial — 3 of ~40 closed this cycle** |
