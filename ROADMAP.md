...
| V8-06 | **Blueprint test coverage** | ~40 of 72 blueprints lack test suites. **`roadmap_features.py`** covered v7.65.1-pre follow-up (`89d1818`, 25 tests). **`specialized_modules.py`** covered 2026-04-24 late-PM (`d581cd4` + hardening `7acc471`, 45 tests — 1,794 LOC; 4 findings closed in-place). **`disaster_modules.py`** covered 2026-04-24 late-PM (`189099f`, 38 tests — 898 LOC). **`land_assessment.py`** covered 2026-04-24 late-PM (`fdaed58`, 30 tests — 465 LOC). **`kiwix.py`** covered 2026-04-24 late-PM (`tests/test_blueprint_kiwix.py`, 21 tests — all 7 routes hermetically mocked; SSRF guard verified against 4 attack vectors; check-updates prefix-match logic pinned — 137 LOC). Still open: `daily_living.py`, `hunting_foraging.py`, `hardware_sensors.py`, `supplies.py`, `benchmark.py`, `brief.py`, `kb.py`, `federation.py`, `homestead.py`, and ~26 others. | **Partial — 5 of ~40 closed this cycle** |
