...
| V8-06 | **Blueprint test coverage** | ~40 of 72 blueprints lack test suites. **`roadmap_features.py`** covered v7.65.1-pre follow-up (`89d1818`, 25 tests). **`specialized_modules.py`** covered 2026-04-24 late-PM (`d581cd4` + hardening `7acc471`, 45 tests across 14 resources — 1,794 LOC / 60+ routes; 4 findings closed in-place). **`disaster_modules.py`** covered 2026-04-24 late-PM (`189099f`, 38 tests across 9 resources — 898 LOC). **`land_assessment.py`** covered 2026-04-24 late-PM (`tests/test_blueprint_land_assessment.py`, 30 tests across 6 resource classes — properties, assessments with 23-criterion seed, weighted-score calculator with 3 hand-computed cases, features, dev-plans, BOL comparison aggregator, summary dashboard, criteria-defaults — 465 LOC / 21 routes). Still open: `daily_living.py`, `hunting_foraging.py`, `hardware_sensors.py`, `supplies.py`, `benchmark.py`, `brief.py`, `kb.py`, `kiwix.py`, `federation.py`, `homestead.py`, and ~26 others. | **Partial — 4 of ~40 closed this cycle** |
